...
import { ListFrequentlyPurchasedProductsResult } from './list-frequently-purchased-products.result';

@QueryHandler(ListFrequentlyPurchasedProductsQuery)
export class ListFrequentlyPurchasedProductsHandler
  implements
    IQueryHandler<
      ListFrequentlyPurchasedProductsQuery,
      ListFrequentlyPurchasedProductsResult
    >
{
  constructor(
    @InjectPinoLogger(ListFrequentlyPurchasedProductsHandler.name)
  ...
  async execute(
    query: ListFrequentlyPurchasedProductsQuery,
  ): Promise<ListFrequentlyPurchasedProductsResult> {
    ...
    const collection = await this.repository.getFrequentlyPurchasedProducts(
      query,
    );
    ...
    return new ListFrequentlyPurchasedProductsResult(collection);
  }
}
